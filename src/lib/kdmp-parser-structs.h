...
struct BMP_HEADER64 {
  static inline uint32_t ExpectedSignature = 0x504D4453;  // 'PMDS'
  static inline uint32_t ExpectedSignature2 = 0x504D4446; // 'PMDF'
  static inline uint32_t ExpectedValidDump = 0x504D5544;  // 'PMUD'
